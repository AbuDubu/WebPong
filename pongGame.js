class PongGame{
    ...
    updateScore(){
        document.getElementById('paddle1Score').innerHTML = "Paddle 1 Score: " + this.paddle1.score;
        document.getElementById('paddle2Score').innerHTML = "Paddle 2 Score: " + this.paddle2.score;
    }
    resetGame(){
